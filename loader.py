...
def default_flist_reader(flist):
    ...
    return imlist # đg dẫn tới ảnh vs label tương ứng
...
class ImageFileList(data.Dataset):
    ...
    def __getitem__(self, index): # chuẩn hóa ảnh và label của nó
    ...
    def __len__(self): # lấy số tập dữu liệu
